...
/*** PowerThermal events' keys ***/
	...
	/* IP idle time */
	#define E903001016_IDLETIME_INT 3
	/* IP busy time */
	#define E903001016_BUSYTIME_INT 4
	/* IP power consumption */
	#define E903001016_POWER_FLOAT 5
	...
	#define E903001017_SEARCHCOUNT_SMALLINT 5
	/* Idle total time */
	#define E903001017_IDLETIME_INT 6
	/* Idle DRX total count */
	#define E903001017_DRXCOUNT_INT 7
	/* DRX count of which during time less than 15ms */
	#define E903001017_DRXCOUNT_15_INT 8
	/* DRX count of which during time less than Xms */
	#define E903001017_DRXCOUNT_X_INT 9
	/* Received signal strength in weak signal */
	#define E903001017_RSSIWEAK_INT 10
	/* Received signal strength in middle signal */
	#define E903001017_RSSIMID_INT 11
	/* Received signal strength in strong signal */
	#define E903001017_RSSISTRONG_INT 12
	/* Neighbor cell measurement count less than X */
	#define E903001017_NCELLMEASCOUNT_X_INT 13
	/* Neighbor cell measurement count span */
	#define E903001017_NCELLMEASSPAN_INT 14
	/* Inter Rat measurement total count */
	#define E903001017_INTERRATMEASCOUNT_INT 15
	/* CS total time */
	#define E903001017_CSTIME_INT 16
	/* CS low Tx power */
	#define E903001017_CSTXPWRLOW_INT 17
	/* CS middle Tx power */
	#define E903001017_CSTXPWRMID_INT 18
	/* CS high Tx power */
	#define E903001017_CSTXPWRHIGH_INT 19
	/* PS total time */
	#define E903001017_PSTIME_INT 20
	/* Class10 total time */
	#define E903001017_CLASS10TIME_INT 21
	/* ClassX total time */
	#define E903001017_CLASSXTIME_INT 22
	/* PS low Tx power */
	#define E903001017_PSTXPWRLOW_INT 23
	/* PS middle Tx power */
	#define E903001017_PSTXPWRMID_INT 24
	/* PS high Tx power */
	#define E903001017_PSTXPWRHIGH_INT 25
	...
	/* Search network count */
	#define E903001018_SEARCHCOUNT_SMALLINT 5
	/* Idle total time */
	#define E903001018_IDLETIME_INT 6
	/* Idle DRX total count */
	#define E903001018_DRXCOUNT_INT 7
	/* DRX count of which during time less than 15ms */
	#define E903001018_DRXCOUNT_15_INT 8
	/* DRX count of which during time less than Xms */
	#define E903001018_DRXCOUNT_X_INT 9
	/* Received signal strength in weak signal */
	#define E903001018_RSCPWEAK_INT 10
	/* Received signal strength in middle signal */
	#define E903001018_RSCPMID_INT 11
	/* Received signal strength in strong signal */
	#define E903001018_RSCPSTRONG_INT 12
	/* Neighbor cell measurement count less than X */
	#define E903001018_NCELLMEASCOUNT_X_INT 13
	/* Neighbor cell measurement count span */
	#define E903001018_NCELLMEASSPAN_INT 14
	/* Inter Rat measurement total count */
	#define E903001018_INTERRATMEASCOUNT_INT 15
	/* CS total time */
	#define E903001018_CSTIME_INT 16
	/* FET Count */
	#define E903001018_FETCOUNT_INT 17
	/* CS low Tx power */
	#define E903001018_CSTXPWRLOW_INT 18
	/* CS middle Tx power */
	#define E903001018_CSTXPWRMID_INT 19
	/* CS high Tx power */
	#define E903001018_CSTXPWRHIGH_INT 20
	/* PS total time */
	#define E903001018_PSTIME_INT 21
	/* PS low Tx power */
	#define E903001018_PSTXPWRLOW_INT 22
	/* PS middle Tx power */
	#define E903001018_PSTXPWRMID_INT 23
	/* PS high Tx power */
	#define E903001018_PSTXPWRHIGH_INT 24
	...
	/* Search network count */
	#define E903001019_SEARCHCOUNT_SMALLINT 5
	/* Idle total time */
	#define E903001019_IDLETIME_INT 6
	/* Idle PCH DRX total count */
	#define E903001019_PCHDRXCOUNT_INT 7
	/* DRX count of which PCH time less than 80ms */
	#define E903001019_PCHDRXCOUNT_80_INT 8
	/* DRX count of which PCH time more than 160ms */
	#define E903001019_PCHDRXCOUNT_160_INT 9
	/* Idle PCH DRX total count */
	#define E903001019_QPCHDRXCOUNT_INT 10
	/* DRX count of which PCH time more than 60ms */
	#define E903001019_QPCHDRXCOUNT_60_INT 11
	/* Received signal strength in weak signal */
	#define E903001019_RSSIWEAK_INT 12
	/* Received signal strength in middle signal */
	#define E903001019_RSSIMID_INT 13
	/* Received signal strength in strong signal */
	#define E903001019_RSSISTRONG_INT 14
	/* Neighbor cell measurement count less than 30 */
	#define E903001019_NCELLMEASCOUNT_30_INT 15
	/* Neighbor cell measurement count more than 60 */
	#define E903001019_NCELLMEASCOUNT_60_INT 16
	/* Inter Rat measurement total count */
	#define E903001019_INTERRATMEASCOUNT_INT 17
	/* CS total time */
	#define E903001019_CSTIME_INT 18
	/* CS low Tx power */
	#define E903001019_CSTXPWRLOW_INT 19
	/* CS middle Tx power */
	#define E903001019_CSTXPWRMID_INT 20
	/* CS high Tx power */
	#define E903001019_CSTXPWRHIGH_INT 21
	/* PS total time */
	#define E903001019_PSTIME_INT 22
	/* PS low Tx power */
	#define E903001019_PSTXPWRLOW_INT 23
	/* PS middle Tx power */
	#define E903001019_PSTXPWRMID_INT 24
	/* PS high Tx power */
	#define E903001019_PSTXPWRHIGH_INT 25
	...
	/* Search network count */
	#define E903001020_SEARCHCOUNT_SMALLINT 5
	/* Idle total time */
	#define E903001020_IDLETIME_INT 6
	/* Idle PCH DRX total count */
	#define E903001020_DRXCOUNT_INT 7
	/* DRX count of which during time less than 80ms */
	#define E903001020_DRXCOUNT_80_INT 8
	/* DRX count of which during time more than 160ms */
	#define E903001020_DRXCOUNT_160_INT 9
	/* Received signal strength in weak signal */
	#define E903001020_RSSIWEAK_INT 10
	/* Received signal strength in middle signal */
	#define E903001020_RSSIMID_INT 11
	/* Received signal strength in strong signal */
	#define E903001020_RSSISTRONG_INT 12
	/* Neighbor cell measurement count less than 30 */
	#define E903001020_NCELLMEASCOUNT_30_INT 13
	/* Neighbor cell measurement count more than 60 */
	#define E903001020_NCELLMEASCOUNT_60_INT 14
	/* Inter Rat measurement total count */
	#define E903001020_INTERRATMEASCOUNT_INT 15
	/* PS total time */
	#define E903001020_PSTIME_INT 16
	/* PS low Tx power */
	#define E903001020_PSTXPWRLOW_INT 17
	/* PS middle Tx power */
	#define E903001020_PSTXPWRMID_INT 18
	/* PS high Tx power */
	#define E903001020_PSTXPWRHIGH_INT 19
	...
	/* Search network count */
	#define E903001021_SEARCHCOUNT_SMALLINT 5
	/* Idle total time */
	#define E903001021_IDLETIME_INT 6
	/* Idle DRX total count */
	#define E903001021_DRXCOUNT_INT 7
	/* Thereshold of measuring inter frequency */
	#define E903001021_INTERFREQMEASTHRES_INT 8
	/* Count of measuring inter frequency */
	#define E903001021_INTERFREQMEASCOUNT_INT 9
	/* Number of measured inter frequencies */
	#define E903001021_INTERFREQMEASNUM_INT 10
	/* Time of measuring inter frequency */
	#define E903001021_INTERFREQMEASTIME_INT 11
	/* Threshold of measuring inter rat */
	#define E903001021_INTERRATMEASTHRES_INT 12
	/* Count of measuring inter rat */
	#define E903001021_INTERRATMEASCOUNT_INT 13
	/* Number of measured inter rat frequencies */
	#define E903001021_INTERRATMEASFREQNUM_INT 14
	/* Time of measuring inter rat */
	#define E903001021_INTERRATMEASTIME_INT 15
	/* Received signal strength in weak signal */
	#define E903001021_RSCPWEAK_INT 16
	/* Received signal strength in middle signal */
	#define E903001021_RSCPMID_INT 17
	/* Received signal strength in strong signal */
	#define E903001021_RSCPSTRONG_INT 18
	/* CS total time */
	#define E903001021_CSTIME_INT 19
	/* CS low Tx power */
	#define E903001021_CSTXPWRLOW_INT 20
	/* CS middle Tx power */
	#define E903001021_CSTXPWRMID_INT 21
	/* CS high Tx power */
	#define E903001021_CSTXPWRHIGH_INT 22
	/* PS total time */
	#define E903001021_PSTIME_INT 23
	/* PS low Tx power */
	#define E903001021_PSTXPWRLOW_INT 24
	/* PS middle Tx power */
	#define E903001021_PSTXPWRMID_INT 25
	/* PS high Tx power */
	#define E903001021_PSTXPWRHIGH_INT 26
	...
	/* Search network count */
	#define E903001022_SEARCHCOUNT_SMALLINT 5
	/* Idle total time */
	#define E903001022_IDLETIME_INT 6
	/* Idle DRX total count */
	#define E903001022_DRXCOUNT_INT 7
	/* Thereshold of measuring inter frequency */
	#define E903001022_INTERFREQMEASTHRES_INT 8
	/* Count of measuring inter frequency */
	#define E903001022_INTERFREQMEASCOUNT_INT 9
	/* Number of measured inter frequencies */
	#define E903001022_INTERFREQMEASNUM_INT 10
	/* Time of measuring inter frequency */
	#define E903001022_INTERFREQMEASTIME_INT 11
	/* Threshold of measuring inter rat */
	#define E903001022_INTERRATMEASTHRES_INT 12
	/* Count of measuring inter rat */
	#define E903001022_INTERRATMEASCOUNT_INT 13
	/* Number of measured inter rat frequencies */
	#define E903001022_INTERRATMEASFREQNUM_INT 14
	/* Time of measuring inter rat */
	#define E903001022_INTERRATMEASTIME_INT 15
	/* Received signal strength in weak signal */
	#define E903001022_SRSRPWEAK_INT 16
	/* Received signal strength in middle signal */
	#define E903001022_SRSRPMID_INT 17
	/* Received signal strength in strong signal */
	#define E903001022_SRSRPSTRONG_INT 18
	/* Connect time */
	#define E903001022_CONNECTTIME_INT 19
	/* CDRX time */
	#define E903001022_CDRXTIME_INT 20
	/* PS low Tx power */
	#define E903001022_PSTXPWRLOW_INT 21
	/* PS middle Tx power */
	#define E903001022_PSTXPWRMID_INT 22
	/* PS high Tx power */
	#define E903001022_PSTXPWRHIGH_INT 23
	...
	#define E903001023_INTERPMSUSPENDCOUNT_INT 2
	/* Total count of resume flow */
	#define E903001023_INTERPMRESUMECOUNT_INT 3
	/* Max time of suspend */
	#define E903001023_SUSPENDMAXTIME_INT 4
	/* Average time of suspend */
	#define E903001023_SUSPENDAVGTIME_INT 5
	/* Min time of suspend */
	#define E903001023_SUSPENDMINTIME_INT 6
	/* Max time of resume */
	#define E903001023_RESUMEMAXTIME_INT 7
	/* Average time of resume */
	#define E903001023_RESUMEAVGTIME_INT 8
	/* Min time of resume */
	#define E903001023_RESUMEMINTIME_INT 9
	/* Total sleep time of C core */
	#define E903001023_INTERSLEEPTIME_INT 10
	/* Total work time of C core */
	#define E903001023_INTERWOKTIME_INT 11
	/* Count of interrupt wake up */
	#define E903001023_INTERRUPTWAKEUPCOUNT_VARCHAR 12
	/* Time of interrupt wake up */
	#define E903001023_INTERRUPTWAKEUPTIME_VARCHAR 13
	/* Time of holding wake lock */
	#define E903001023_WAKELOCKTIME_VARCHAR 14
