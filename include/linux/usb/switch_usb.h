...
enum USB_SWITCH_EVENT {
	USB_SWITCH_ATTACH,
	USB_SWITCH_DETACH,
};

extern int usb_switch_register_notifier(struct notifier_block *nb);
extern int usb_switch_unregister_notifier(struct notifier_block *nb);
extern int usb_switch_get_done_flag(void);
