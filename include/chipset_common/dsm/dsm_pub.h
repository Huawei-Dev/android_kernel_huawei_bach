...
/*wifi qcom*/
#define DSM_WIFI_ERR                        (909031001)
#define DSM_WIFI_DRIVER_LOAD_ERR            (909031001)
#define DSM_WIFI_SUPPLICANT_START_ERR       (909031002)
#define DSM_WIFI_CONNECT_SUPPLICANT_ERR     (909031003)
#define DSM_WIFI_MAC_ERR                    (909031004)
#define DSM_WIFI_SCAN_FAIL_ERR              (909031005)
#define DSM_WIFI_FAIL_LOADFIRMWARE_ERR      (909031006)
#define DSM_WIFI_ABNORMAL_DISCONNECT_ERR    (909031007)
#define DSM_WIFI_CANNOT_CONNECT_AP_ERR      (909031008)
