...
void OnInit_FT8606_BasicThreshold(char *strIniFile)
{
	...
	//printk("Enter  OnInit_FT8606_BasicThreshold \n");
	...
	snprintf(g_stCfg_FT8606_BasicThreshold.Project_Code, 32, "%s", str);
	...
	//printk("Exit  OnInit_FT8606_BasicThreshold \n");
...
void OnInit_FT8606_TestItem(char *strIniFile)
{
	...
	//printk("Exit  OnInit_FT8606_TestItem \n");
