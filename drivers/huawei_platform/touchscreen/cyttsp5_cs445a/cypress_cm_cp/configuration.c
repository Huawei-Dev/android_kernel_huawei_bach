...
int configuration_get(struct file *file, struct configuration *configuration)
{
	...
	tp_log_err("%s: family_type:%d\n", __func__,
			configuration->family_type);
	tp_log_err("%s: cm_excluding_col_edge:%d\n", __func__,
			configuration->cm_excluding_col_edge);
	tp_log_err("%s: cm_range_limit_row:%d\n", __func__,
			configuration->cm_range_limit_row);
	tp_log_err("%s: cm_range_limit_col:%d\n", __func__,
			configuration->cm_range_limit_col);
	tp_log_err("%s: cm_min_limit_cal:%d\n", __func__,
			configuration->cm_min_limit_cal);
	tp_log_err("%s: cm_max_limit_cal:%d\n", __func__,
			configuration->cm_max_limit_cal);
	tp_log_err("%s: cm_max_delta_sensor_percent:%d\n", __func__,
			configuration->cm_max_delta_sensor_percent);
	tp_log_err("%s: cm_max_delta_button_percent:%d\n", __func__,
			configuration->cm_max_delta_button_percent);
	tp_log_err("%s: cp_max_delta_button_percent:%d\n", __func__,
			configuration->cp_max_delta_button_percent);
	tp_log_err("%s: cp_max_delta_sensor_rx_percent:%d\n", __func__,
		configuration->cp_max_delta_sensor_rx_percent);
	tp_log_err("%s: cp_max_delta_sensor_tx_percent:%d\n", __func__,
		configuration->cp_max_delta_sensor_tx_percent);
	tp_log_err("%s: cm_min_max_table_button_size:%d\n",
			__func__,
			configuration->cm_min_max_table_button_size);
	tp_log_err("%s: cm_min_max_table_sensor_size:%d\n",
			__func__,
			configuration->cm_min_max_table_sensor_size);
	tp_log_err("%s: cp_min_max_table_rx_size:%d\n",
			__func__,
			configuration->cp_min_max_table_rx_size);
	tp_log_err("%s: cp_min_max_table_tx_size:%d\n",
			__func__,
